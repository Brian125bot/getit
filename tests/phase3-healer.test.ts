...
test('Phase 3 Healer: Match Command Not Found', async () => {
  const stderr = 'bash: curl: command not found';
  const result = await attemptDependencyHealing(stderr);
...
test('Phase 3 Healer: Match Command Not Found Alt Format', async () => {
...
test('Phase 3 Healer: Match Missing Shared Library', async () => {
...
test('Phase 3 Healer: Match Missing Python Package', async () => {
...
test('Phase 3 Healer: Match Missing Node Module', async () => {
...
test('Phase 3 Healer: Safe non-match on normal errors', async () => {
